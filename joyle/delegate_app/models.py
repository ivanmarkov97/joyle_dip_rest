...
class Delegation(models.Model):
	sender = models.ForeignKey(User, on_delete=models.CASCADE, related_name='delegate_sender')
	owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name='delegate_recipient')
